    ...
    <>
      <div className="page home-page">
        ...
        >
          ...
          <Modal.Body>
            <Modal.Title className="custom-text-color">Sign In</Modal.Title>
            <Form className="form-group" onSubmit={handleSubmit}>
              <Form.Group className="custom1-text-color" controlId="email">
                ...
                <Row>
                  <Col sm={12} className="button">
                    <Col className="d-flex justify-content-end">
                      <div className="col-lg pr-0 d-flex flex-column button">
                        <Button
                          variant="success"
                          className="c-button s-md success font-weight-bold mb-4 d-inline-flex"
                        >
                          Sign In
                        </Button>
                        <Button
                          variant="secondary"
                          className="c-button s-md secondary mb-4 d-inline-flex"
                          data-dismiss="modal"
                        >
                          Cancel
                        </Button>
